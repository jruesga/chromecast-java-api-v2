    ...
    private class PingThread extends TimerTask {
        ...
        public void run() {
            try {
                ...
                System.err.println("Error while sending 'PING'");
            ...
            while (!stop) {
                ...
                try {
                    ...
                    if (message.getPayloadType() == CastChannel.CastMessage.PayloadType.STRING) {
                        ...
                        System.err.println("Received unexpected " + message.getPayloadType() + " message");
                    }
                    ...
                    System.err.println("Unknown error while reading");
                    e.printStackTrace();
                    continue;
                }
                ...
                try {
                    ...
                    if (isAppEvent(parsed)) {
                        ...
                        } else if (message.getNamespace().equals("urn:x-cast:com.google.cast.media")
                                && parsed.has("responseType") && parsed.get("responseType").asText().equals("MEDIA_STATUS")) {
                            notifyListenersOfSpontaneousEvent(parsed);
                    ...
                    System.err.println("Error while handling");
                    e.printStackTrace();
                }
            }
        }
